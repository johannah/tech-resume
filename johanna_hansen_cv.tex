...
{\bf McGill University, Montreal, QC} \hfill {\em 2016 -- 2023} \\ 
\setlength{\parindent}{3ex}
\indent{Ph.D. in Computer Science (expected), Mobile Robotics Lab} \\
\indent{Thesis work on Planning with Prediction in Scientific Sampling Robots}\\
...
%
%\textbf{Working Draft} Planning with Learned State Associations 
