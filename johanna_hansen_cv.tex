...
\setlength{\parindent}{3ex}
 \indent{Ph.D. in Computer Science in the {Mobile Robotics Lab}} \\
 \indent{Thesis work on \emph{Decision Making in Robotic Systems}}\\
  \indent{under the supervision of Dr. Gregory Dudek}\\
\noindent {\bf University of Texas at San Antonio, San Antonio, TX} \hfill {\em 2012 -- 2015} \\ 
\indent {Graduate coursework towards Electrical Engineering (Digital Signal Processing)} \\
...
\textbf{Hansen, J.}, Manjanna, S.,  Quattrini, L. A., Rekleitis, I., Dudek, G., \textit{Autonomous Marine Sampling Enhanced by Strategically Deployed Drifters in Marine Flow Fields}, 2018 MTS/IEEE OCEANS, \emph{\textbf{(Top 20 Student Submission)}}
...
\textbf{Hansen, J.}*, Kastner, K.*, Courville, A., Dudek, G.,  \textit{Planning in Dynamic Environments with Conditional Autoregressive Models}, 2018 ICML workshop on Prediction and Generative Modeling in Reinforcement Learning.  
...
\textbf{Hansen, J.}, Fourie, D., Kinsey, J., Pontbriand, C., Ware, J., Farr, N., Kaiser, C., and Tivey, M., \textit{Autonomous Acoustic-Aided Optical Localization for Data Transfer}, 2015 MTS/IEEE OCEANS.
