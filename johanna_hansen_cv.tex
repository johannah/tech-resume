...
\address{ jh1736@gmail.com \\ johannah.github.io } % Your phone number and email
...
{\bf University of Texas at San Antonio, GPA: 3.81} \hfill {\em May 2016} \\ 
San Antonio, Texas USA \\
{\bf M.S. in Electrical Engineering} \\
Concentration in Digital Signal Processing \\
Advised by Dr. Sos Agaian \\

{\bf Texas State University, GPA 3.61 \textit{Cum Laude}} \hfill {\em Dec 2011} \\ 
...
\begin{rSubsection}{Woods Hole Oceanographic Institution (WHOI)}{Jan 2014 - Present}{Software Engineer, National Deep Submergence Facility}{Woods Hole, MA}
...
2015: CapePy Python Meetup Tutorial: Introduction to Machine Learning with sklearn \smallskip \\
2015: SciPy 2015 Talk: Characterizing the Seafloor with Python as a Toolbox \smallskip \\
2015: Big-data, Robotics, Autonomy, Technology and Sensing (BRATS) Talk: Standardizing Machine Learning Tasks with sklearn \\
\end{rSection}
...
\item{Founder and Technical Organizer of WHOI-Software Technical Group with monthly presentations from domain experts}
