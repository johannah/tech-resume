...
\setlength{\parindent}{3ex}
 ...
 \indent{Thesis work on Decision Making in Robotic Systems \\
         under the supervision of Dr. Gregory Dudek}
...
\indent{Capstone: \textit{Identifying Devices in the Power Grid by their Current Signatures}} \\
...
\textbf{Hansen, J.}*, Kastner, K.*, Courville, A., Dudek, G.,  Planning in Dynamic Environments with Conditional Autoregressive Models, 2018 ICML workshop on Prediction and Generative Modeling in Reinforcement Learning. http://reinforcement-learning.ml/papers/pgmrl2018_hansen.pdf 
